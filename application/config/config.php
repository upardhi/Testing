...
define('HTTP_PRODUCT_IMAGES_PATH', $config['base_url'].'uploads/product_images/');
...
define('VIEW_IMAGES','uploads/view_images/');
define('VIEW_IMAGES_ABS_PATH', $config['base_url'].'uploads/view_images/');

define('PRODUCT_IMAGES_ABS_PATH', $config['base_url'].'uploads/product_images/');

define('COLORS_PATH', 'uploads/color_images/');
define('COLORS_IMAGE_MAX_SIZE', '2048');
define('COLOR_IMAGE_ABS_PATH', $config['base_url'].'uploads/color_images/');



define('FONTS_PATH', 'uploads/font_images/');
define('FONTS_IMAGE_MAX_SIZE', '2048');
define('FONTS_IMAGE_ABS_PATH', $config['base_url'].'uploads/font_images/');

define('CLIPARTS_PATH', 'uploads/clipart_images/');
define('CLIPART_IMAGE_ABS_PATH', $config['base_url'].'uploads/clipart_images/');
define('CLIPART_IMAGE_MAX_SIZE', '2Mb');

define('TEMPLATE_SVG_PATH', 'uploads/template_svg/');
define('TEMPLATE_SVG_ABS_PATH', $config['base_url'].'uploads/template_svg/');


define('USER_UPLOADED_PATH', 'uploads/user_uploaded_images/');
