...
class Image_magician
{
	...
	private $imagemagick_path = IMAGE_MAGIC_DIR_PATH;
	 ...
	 */
	public function change_format($image_path, $new_format = 'jpg',$overwrite_original = FALSE )
	{
...
//echo $cmd; die('SSS');
	...
	public function generate_png($svg,$png_name){

		$retval = null;
		$output = array();

		$cmd =  ' convert '. $svg .' -background none ' . TEMPLATE_PNG_DIR_PATH . $png_name.'.png 2>&1';
